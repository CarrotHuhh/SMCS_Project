...
def main(data_filepath):
    ...
    best_cost, best_sol = scp_solver.probabilistic_heuristic_gpu_parallel(N_iterations, alpha_value, a, b)
    ...
    for idx, rc_pct in enumerate(row_percentages):
        ...
        best_cost_2, best_sol_2 = scp_solver.probabilistic_heuristic_gpu_parallel(N_iterations, alpha_value, a, b, is_row_constraint, row_constraint)
